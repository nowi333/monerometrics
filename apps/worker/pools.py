...
POOL_APIS = {'supportxmr.com': ('https://www.supportxmr.com/api/pool/blocks?limit={limit}', 'standard'), 'p2pool': ('https://p2pool.observer/api/pool/blocks?limit={limit}', 'standard'), 'p2pool-mini': ('https://mini.p2pool.observer/api/pool/blocks?limit={limit}', 'standard'), 'p2pool-nano': ('https://nano.p2pool.observer/api/pool/blocks?limit={limit}', 'standard'), 'hashvault.pro': ('https://api.hashvault.pro/v3/monero/pool/blocks?limit={limit}&page=0', 'standard'), 'moneroocean.stream': ('https://api.moneroocean.stream/pool/blocks?limit=100', 'standard'), 'c3pool.com': ('https://api.c3pool.org/pool/blocks?limit={limit}', 'standard'), 'nanopool.org': ('https://xmr.nanopool.org/api/v1/pool/blocks/0/{limit}', 'nanopool'), 'kryptex.com': ('https://pool.kryptex.com/xmr/api/v1/pool/blocks?limit={limit}', 'kryptex'), 'herominers.com': ('https://monero.herominers.com/api/get_blocks?height={height}', 'cryptonote_paged'), 'xmrpool.eu': ('https://web.xmrpool.eu:8119/get_blocks?height={height}', 'cryptonote_paged'), 'monerohash.com': ('https://monerohash.com/api/get_blocks?height={height}', 'cryptonote_paged')}
