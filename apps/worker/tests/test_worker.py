"""Tests unitaires du worker : logique pure (sans node ni base)."""
import os
import sys
...
# === Difficulte exacte (wide_difficulty hex vs difficulty tronque) ===

def test_difficulty_of_prefers_wide():
    # wide_difficulty (hex) doit primer sur difficulty (entier JSON tronque)
...
# === Regroupement des reorgs en evenements contigus ===
...
# === Parsing des reponses pools (4 formats) ===
...
def test_parse_herominers_alternating():
    # liste plate alternee : "hash:ts:...", height, ...
    h64 = "a" * 64
