          ...
          {!interacted && (
            ...
            >
              <svg width="13" height="13" viewBox="0 0 24 24" aria-hidden="true" className="shrink-0">
                <path
                  d="M8.4 7.6c0-1.1.9-2 2-2s2 .9 2 2v4.8c.3-.5.9-.8 1.5-.8.8 0 1.5.5 1.7 1.3.3-.3.8-.5 1.3-.5.9 0 1.6.6 1.8 1.4.3-.2.7-.3 1.1-.3 1 0 1.9.8 1.9 1.9v2.9c0 3.1-2.5 5.7-5.7 5.7h-2.3c-1.7 0-3.2-.8-4.3-2.1l-3-3.7c-.6-.8-.5-1.9.3-2.5.7-.6 1.8-.5 2.4.2l1.3 1.5z"
                  fill="currentColor"
