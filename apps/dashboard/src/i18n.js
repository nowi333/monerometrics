    ...
    resources: {
      en: {
        translation: {
          ...
          'charts.zoomHint': 'scroll to zoom · drag to pan',
          // Top pools table
      ...
      fr: {
        translation: {
          ...
          'charts.avg': 'Moy',
          'charts.max': 'Max',
          'charts.resetZoom': 'Reinitialiser le zoom',
          'charts.fullscreen': 'Plein ecran',
          'charts.zoomHint': 'molette pour zoomer · glisser pour deplacer',
          // Top pools table
          'toppools.title': 'Top mining pools',
          'toppools.pool': 'Pool',
      ...
      es: {
        translation: {
          ...
          'charts.zoomHint': 'rueda para zoom · arrastra para mover',
          // Top pools table
