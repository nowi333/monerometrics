# variables.tf — Environnement POC (Hetzner Cloud)
...
# Cle publique SSH d'administration. Le pendant prive vit hors du depot
# (ex: ~/.ssh/monerometrics/bastion). Passee via terraform.tfvars (gitignored).
...
# Types de serveurs (gamme x86 cx*/cpx* pour la compatibilite des images amd64).
